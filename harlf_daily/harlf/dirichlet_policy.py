...
# This policy uses Dirichlet distribution, so both names make sense
DirichletActorCriticPolicy = SoftmaxActorCriticPolicy
...
if __name__ == '__main__':
    ...
    if success:
        ...
        print("\nUsage:")
        print("  from harlf.dirichlet_policy import SoftmaxActorCriticPolicy")
        print("  # or")
        print("  from harlf.dirichlet_policy import DirichletActorCriticPolicy")
