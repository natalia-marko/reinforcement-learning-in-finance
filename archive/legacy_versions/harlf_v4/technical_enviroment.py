"""
Technical Environment - Optimized for Monthly Data with Log Returns
...
class TechnicalEnv(gymnasium.Env):
    """
    Technical indicators-based trading environment for portfolio optimization.
    ...
    def __init__(self, price_data, features, initial_capital=100000, 
        ...
        # Observation space: technical features
        ...
        # Find common dates between features and prices
        self.common_dates = features.index.intersection(price_data.index)
    ...
    def _get_observation(self):
        """Get current observation (technical features)"""
        ...
        obs = self.features.loc[current_date].values
    ...
    def get_detailed_metrics(self):
        ...
        if len(returns) > 0:
            ...
            # Information ratio (if benchmark available, using 0 for now)
            benchmark_return = 0
